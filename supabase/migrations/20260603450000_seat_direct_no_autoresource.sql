-- ============================================================
-- Revert the auto-forge-resource behaviour (#6 follow-up): a resource must be
-- declared on the member's OWN card (scope=member, reviewed) before it can be
-- committed — not conjured silently during seating. seat_direct now requires a
-- resource for a work_resource seat and errors clearly if missing.
-- ============================================================
