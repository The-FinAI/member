...
<style>
  ...
  .ni-pop { position: absolute; right: 0; top: 2rem; width: 22rem; max-width: 90vw; background: var(--card, #fff); border: 1px solid var(--line, #e2e2e2); border-radius: 12px; box-shadow: 0 8px 28px rgba(0,0,0,.12); z-index: 41; max-height: 70vh; overflow: auto; }
  ...
  .ni-readall { border: none; background: none; color: var(--accent, #6a7cff); cursor: pointer; font-size: .78rem; }
