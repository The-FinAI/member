...
<style>
  ...
  .kbtn.on { background: var(--accent, var(--accent)); color: #fff; }
  ...
  .np-n { width: 4rem; }
  .np-go { border: none; background: var(--accent, var(--accent)); color: #fff; border-radius: var(--r-sm); padding: .3rem .75rem; cursor: pointer; }
  ...
  .np-err { color: var(--neg, var(--down)); font-size: .8rem; display: block; margin-top: .35rem; }
  .np-pool { color: var(--up); font-size: .82rem; display: block; margin-top: .35rem; }
  ...
  .np-toggle:hover { border-color: var(--accent, var(--accent)); color: var(--accent, var(--accent)); }
</style>
