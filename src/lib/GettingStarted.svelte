<script lang="ts">
  ...
  onMount(async () => {
    ...
    steps = [
      ...
      { key: 'certify', title: 'Certify a skill', blurb: 'Earn a reviewed role card to turn a skill into a credential and raise your labor rate.', href: '/community?tab=crafts', cta: 'Browse the craft ladder', done: certified }
    ];
    ready = true;
  });
